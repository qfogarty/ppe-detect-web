        ...
        <div className="App">
            ...
            <div className={`container mx-auto flex flex-col space-x-4 items-center mt-8`}>
                <div className={`flex-1`}>
                    <label
                        className="w-64 flex flex-col items-center border-solid border-2 border-night px-6 mt-10">
                    ...
                    <button onClick={handleFileUpload} className={`border-solid border-4 border-night rounded-full py-3 px-6 mt-10`}>Upload</button>
                </div>
                <div className={`flex-1`}>
                    {/*<h2>Result</h2>*/}
                </div>
